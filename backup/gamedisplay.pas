...
begin
  ...
  with canvas_ do
    ...
    if (isRow and (clue.row = fgame.selectedRowClueSet)
      and (clue.index = fgame.SelectedRowClueIndex))
    or ((isRow=false) and (clue.column = fGame.selectedColumnClueSet)
      and (clue.index = fGame.selectedColumnClueIndex))
